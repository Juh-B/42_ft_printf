...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   putunbr_flag_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jcosta-b <jcosta-b@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/16 11:33:49 by jcosta-b          #+#    #+#             */
/*   Updated: 2024/12/16 11:37:56 by jcosta-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static size_t	putflags_unsig(t_printf spec, unsigned int n)
{
	size_t	count;
	size_t	len_str_w;
	size_t	len_str_p;
...
static size_t	putflag_unsig_minus(t_printf spec, unsigned int n)
{
	size_t	count;
	size_t	len_str_w;
	size_t	len_str_p;
