...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/10 17:17:57 by jcosta-b          #+#    #+#             */
/*   Updated: 2024/12/11 17:32:22 by jcosta-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf_bonus.h"

static size_t	printf_putnbr_base(printf_format spec, unsigned long n)
{
	size_t	count;
  char    *base;
...
static size_t	putflags_hex(printf_format spec, unsigned long n)
{
	size_t	count;
	size_t	len_str_w;
	size_t	len_str_p;
...
static size_t	putflag_hex_minus(printf_format spec, unsigned long n)
{
	size_t	count;
	size_t	len_str_w;
	size_t	len_str_p;
